...
void MuseScore::createNewWorkspace()
      {
      QString s = QInputDialog::getText(this, tr("Virtual Guitar: Read Workspace Name"),
         tr("Workspace name:"));
      if (s.isEmpty())
            return;
      ...
      for (;;) {
            ...
            if (!notFound) {
                  s = QInputDialog::getText(this,
                     tr("Virtual Guitar: Read Workspace Name"),
...
static void writeFailed(const QString& _path)
      ...
      QMessageBox::critical(mscore, qApp->translate("Workspace", "Virtual Guitar: Writing Workspace File"), s.arg(_path));
      }
