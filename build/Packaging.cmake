...
SET(CPACK_PACKAGE_DESCRIPTION_SUMMARY "Virtual Guitar is a full featured WYSIWYG score editor and Guitar tutor")
SET(CPACK_PACKAGE_VENDOR "Werner Schweer and Others, modified by Florin Braghis")
...
SET(CPACK_PACKAGE_INSTALL_DIRECTORY "VirtualGuitar")
...
IF(MINGW)
    ...
    SET(CPACK_NSIS_DISPLAY_NAME "${MUSESCORE_NAME}")
    SET(CPACK_NSIS_HELP_LINK "https://github.com/vguitar/vguitar")
    SET(CPACK_NSIS_URL_INFO_ABOUT "https://github.com/vguitar/vguitar")
    SET(CPACK_NSIS_CONTACT "florin.braghis@gmail.com")
  ...
  SET(CPACK_WIX_PRODUCT_GUID "809c6dd4-b062-4ee6-b90d-a05cfa3964d4")
  SET(CPACK_WIX_UPGRADE_GUID "681a7469-600e-4bf3-aad7-ce661f96a7a7")
...
set(CPACK_PACKAGE_CONTACT       "florin.braghis@gmail.com")
